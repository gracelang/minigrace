...
REALSOURCEFILES = ast.grace compiler.grace errormessages.grace fastDict.grace genjs.grace identifierKinds.grace identifierresolution.grace io.grace lexer.grace mirror.grace parser.grace prefixTree.grace regularExpression.grace scope.grace shasum.grace sourcePosition.grace sys.grace unicode.grace unixFilePath.grace util.grace xmodule.grace
