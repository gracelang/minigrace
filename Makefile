...
REALSOURCEFILES = ast.grace basic.grace compiler.grace constantScope.grace errormessages.grace genjs.grace identifierresolution.grace io.grace lexer.grace mirror.grace parser.grace regularExpression.grace scope.grace shasum.grace sys.grace typeComparison.grace unicode.grace unixFilePath.grace util.grace xmodule.grace
