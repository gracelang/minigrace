...
method compileobjouter(selfr, outerRef) {
    ...
    out("  call void @adddatum2(%object {selfr}, %object {outerRef}, i32 0)")
...
method compile(vl, of, mn, rm, bt, glpath) {
    ...
    outprint("%ClassDataStruct = type \{ i8*, %Method*, i32 \}")
    outprint("%ClassData = type %ClassDataStruct*")
    outprint("%object = type %ObjectStruct*")
    outprint("%ObjectStruct = type \{ i32, %ClassData, [0 x i8] \}")
