...
class Scope.new(parent', variety') {
    ...
    method alreadyDefines(node) {
        ...
        if (elements.get(name) == "inherited") then { return false }
...
method setupContext {
    ...
    preludeObj.addName "Object"
    preludeObj.addName "Unknown"
    preludeObj.addName "String"
    preludeObj.addName "Number"
    preludeObj.addName "Boolean"
    preludeObj.addName "List"
    preludeObj.addName "Block"
    preludeObj.addName "Done"
    preludeObj.addName "done"
    preludeObj.addName "true"
    preludeObj.addName "false"
    preludeObj.addName "self"
    preludeObj.addName "super"
    preludeObj.addName "outer"
    ...
    preludeObj.addName "prelude"
    preludeObj.putScope("prelude", preludeObj)
    preludeObj.addName "_prelude"
    preludeObj.putScope("_prelude", preludeObj)
    preludeObj.addName "..."
    preludeObj.addName "GraceType"
    preludeObj.addName "Exception"
    preludeObj.addName "PrimitiveArray"
    preludeObj.addName "NoSuchMethod"
    preludeObj.addName "ProgrammingError"
    preludeObj.addName "ResourceException"
    preludeObj.addName "RuntimeError"
    preludeObj.addName "BoundsError"
    preludeObj.addName "EnvironmentException"
