class catClass { method move { "walk" } }
trait catTrait { method move { "walk" } } 
class fishClass { method move { "swim" } } 
class fishTrait { method move { "swim" } } 
...
print(allClasses.move)
print(allClasses2.move)
